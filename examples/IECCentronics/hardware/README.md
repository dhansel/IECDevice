...
Once the bootloader is installed, you can upload the firmware:
  ...
  5. Edit the IECDevice/src/IECConfig.h file and UN-comment the following three defines:<br> ```#define IEC_USE_LINE_DRIVERS```,  ```#define IEC_USE_INVERTED_LINE_DRIVERS```, ```#define IEC_USE_INVERTED_INPUTS```
  6. Select "Arduino UNO" as the board type
  7. Select the proper serial port for your adapter
  8. Click the "Upload Sketch" button
